...
public class RankApiController {
    ...
    public ResponseEntity<ApiResponse<Void>> aggregate(@Valid @RequestBody RankAggregateRequest request) {
        rankCommandService.aggregate(request.type(), request.baseDate(), request.limit());
    ...
    public ResponseEntity<ApiResponse<Long>> createPeriod(@Valid @RequestBody RankPeriodCreateRequest request) {
        Long id = rankCommandService.createPeriod(request.startAt(), request.endAt(), request.visible());
    ...
    public ResponseEntity<ApiResponse<Void>> updatePeriod(
        ...
        rankCommandService.updatePeriod(id, request.startAt(), request.endAt(), request.visible());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePeriod(@PathVariable Long id) {
        rankCommandService.deletePeriod(id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Long>> createPrize(
        ...
        Long prizeId = rankCommandService.createPrize(id, request.prizeRank(), request.name(), request.brand(), request.imageFileId());
    ...
    public ResponseEntity<ApiResponse<Void>> updatePrize(
        ...
        rankCommandService.updatePrize(prizeId, request.prizeRank(), request.name(), request.brand(), request.imageFileId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePrize(@PathVariable Long prizeId) {
        rankCommandService.deletePrize(prizeId);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
