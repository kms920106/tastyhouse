package com.tastyhouse.adminapi.event.request;
...
public record EventUpdateRequest(
    ...
    @Schema(description = "이벤트 상태 (SCHEDULED: 예정, ACTIVE: 진행중, ENDED: 종료)", example = "ACTIVE", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = {"SCHEDULED", "ACTIVE", "ENDED"})
    String status,
