 ...
 * {@code MailVerificationJpaEntity} + {@code MailVerificationMapper}가 담당한다. 도메인이
 * 프레임워크-프리이므로 변경 후 저장은 더티 체킹이 아니라 호출부가 명시적으로
 * {@code MailVerificationRepository#save}를 호출해야 한다.
 *
...
public class MailVerification {
     ...
     * {@code MailVerificationMessage}가 참조할 수 있게 공개한다 — 양쪽에 리터럴을 복제하면
    ...
    private MailVerificationStatus status; // 인증 상태
    ...
    /**
     * 신규 메일 인증을 생성한다. 아직 영속되지 않았으므로 식별자는 없다.
     */
