...
class ProductBbqTest {
    ...
    void of_createsTransientProductBbq() {
        ProductBbq bbq = ProductBbq.of(1L, 100L, 200L, false);

        assertThat(bbq.getId()).isNull();
        assertThat(bbq.getProductId()).isEqualTo(1L);
        assertThat(bbq.getBbqMenuId()).isEqualTo(100L);
        assertThat(bbq.getBbqCategoryId()).isEqualTo(200L);
    ...
    void reconstitute_restoresPersistedState() {
        ProductBbq bbq = ProductBbq.reconstitute(1L, 10L, 100L, 200L, true);

        assertThat(bbq.getId()).isEqualTo(1L);
        assertThat(bbq.getProductId()).isEqualTo(10L);
        assertThat(bbq.isOptionsSynced()).isTrue();
    }
}
