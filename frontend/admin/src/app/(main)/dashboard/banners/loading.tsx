...
const SKELETON_COLUMNS = [
  { id: "id", header: "ID", width: 60, align: "left" },
  { id: "type", header: "유형", width: 90, align: "left" },
  { id: "image", header: "이미지", width: 100, align: "left" },
  { id: "title", header: "제목", width: 260, align: "left" },
  { id: "period", header: "노출기간", width: 260, align: "left" },
  { id: "sort", header: "정렬", width: 70, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `banner-row-skeleton-${index}`).map((key) => (
