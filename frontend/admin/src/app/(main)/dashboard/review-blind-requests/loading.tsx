...
const SKELETON_COLUMNS = [
  { id: "createdAt", header: "요청일", width: 160, align: "left" },
  { id: "shopName", header: "가게", width: 160, align: "left" },
  { id: "review", header: "리뷰", width: 320, align: "left" },
  { id: "reason", header: "사유", width: 120, align: "left" },
  { id: "status", header: "상태", width: 100, align: "left" },
  { id: "actions", header: "작업", width: 80, align: "right" },
] as const;

export default function ReviewBlindRequestsLoading() {
  return (
    <Card>
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `blind-request-row-skeleton-${index}`).map(
                  (key) => (
