...
import type { ReviewBlindRequestsTableMeta } from "./review-blind-requests-columns";
...
export function ReviewBlindRequestsTable({
  table,
  isPending,
}: {
  table: TableType<ReviewBlindRequestListItem>;
  isPending: boolean;
}) {
  ...
  const totalElements = (table.options.meta as ReviewBlindRequestsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `blind-request-row-skeleton-${index}`).map((key) => (
              ...
              <TableRow>
                <TableCell colSpan={table.getVisibleLeafColumns().length} className="h-24 text-center">
                  {REVIEW_BLIND_REQUEST_MESSAGE.EMPTY_LIST}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="review-blind-requests-rows-per-page">
