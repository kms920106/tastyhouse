...
import type { PartnershipRequestsTableMeta } from "./partnership-requests-columns";
...
export function PartnershipRequestsTable({
  ...
  table: TableType<PartnershipRequestListItem>;
  isPending: boolean;
}) {
  ...
  const totalElements = (table.options.meta as PartnershipRequestsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `partnership-request-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="partnership-requests-rows-per-page">
