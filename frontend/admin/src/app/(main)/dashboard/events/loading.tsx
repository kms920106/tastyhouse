...
const SKELETON_COLUMNS = [
  ...
  { id: "thumbnail", header: "썸네일", width: 100, align: "left" },
  { id: "name", header: "이벤트명", width: 280, align: "left" },
  { id: "status", header: "상태", width: 100, align: "left" },
  { id: "period", header: "기간", width: 300, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `event-row-skeleton-${index}`).map((key) => (
