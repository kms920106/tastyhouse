...
import type { ShopImageReviewsTableMeta } from "./shop-image-reviews-columns";
...
export function ShopImageReviewsTable({
  table,
  isPending,
}: {
  table: TableType<ShopImageChangeRequest>;
  isPending: boolean;
}) {
  ...
  const totalElements = (table.options.meta as ShopImageReviewsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `image-review-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="shop-image-reviews-rows-per-page">
