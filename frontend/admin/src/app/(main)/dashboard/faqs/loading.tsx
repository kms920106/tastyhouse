...
const SKELETON_COLUMNS = [
  ...
  { id: "category", header: "카테고리", width: 160, align: "left" },
  { id: "question", header: "질문", width: 400, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `faq-row-skeleton-${index}`).map((key) => (
