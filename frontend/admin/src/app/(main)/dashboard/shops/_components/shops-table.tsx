...
import type { ShopsTableMeta } from "./shops-columns";
...
export function ShopsTable({ table, isPending }: { table: TableType<ShopListItem>; isPending: boolean }) {
  ...
  const totalElements = (table.options.meta as ShopsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `shop-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="shops-rows-per-page">
