...
import type { CouponsTableMeta } from "./coupons-columns";
...
export function CouponsTable({ table, isPending }: { table: TableType<CouponListItem>; isPending: boolean }) {
  ...
  const totalElements = (table.options.meta as CouponsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `coupon-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="coupons-rows-per-page">
