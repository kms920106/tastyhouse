...
import type { ShopContentBoardsTableMeta } from "./shop-content-boards-columns";
...
export function ShopContentBoardsTable({ table, isPending }: { table: TableType<ContentBoard>; isPending: boolean }) {
  ...
  const totalElements = (table.options.meta as ShopContentBoardsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `content-board-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="shop-content-boards-rows-per-page">
