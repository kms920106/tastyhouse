...
import type { ShopDeliveryAreaAdjustmentsTableMeta } from "./shop-delivery-area-adjustments-columns";
...
export function ShopDeliveryAreaAdjustmentsTable({
  table,
  isPending,
}: {
  table: TableType<DeliveryAreaAdjustmentListItem>;
  isPending: boolean;
}) {
  ...
  const totalElements = (table.options.meta as ShopDeliveryAreaAdjustmentsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `delivery-area-adjustment-row-skeleton-${index}`).map(
                (key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="shop-delivery-area-adjustments-rows-per-page">
