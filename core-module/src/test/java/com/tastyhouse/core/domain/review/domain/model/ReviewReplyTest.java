...
class ReviewReplyTest {
    ...
    void of_createsTransientReply() {
        ReviewReply reply = ReviewReply.of(1L, MemberId.of(2L), MemberId.of(3L), "답글입니다");

        assertThat(reply.getId()).isNull();
        assertThat(reply.getCommentId()).isEqualTo(1L);
    ...
    void of_allowsNullReplyToMemberId() {
        ReviewReply reply = ReviewReply.of(1L, MemberId.of(2L), null, "답글입니다");
    ...
    void reconstitute_restoresPersistedState() {
        ...
        ReviewReply reply = ReviewReply.reconstitute(
            7L, 1L, MemberId.of(2L), MemberId.of(3L), "답글입니다", true, createdAt
        );
