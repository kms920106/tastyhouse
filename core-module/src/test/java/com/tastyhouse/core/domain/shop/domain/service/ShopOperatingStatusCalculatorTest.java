...
class ShopOperatingStatusCalculatorTest {
    ...
    void open_withinBusinessHours() {
        List<ShopBusinessHour> hours = List.of(
            ShopBusinessHour.reconstitute(1L, 1L, DayType.DAILY, LocalTime.of(9, 0), LocalTime.of(22, 0), false, false)
        );
    ...
    void preparing_outsideBusinessHours() {
        List<ShopBusinessHour> hours = List.of(
            ShopBusinessHour.reconstitute(1L, 1L, DayType.DAILY, LocalTime.of(9, 0), LocalTime.of(11, 0), false, false)
        );
    ...
    void open_24hours() {
        List<ShopBusinessHour> hours = List.of(
            ShopBusinessHour.reconstitute(1L, 1L, DayType.DAILY, null, null, false, true)
        );
    ...
    void open_crossMidnightFromYesterday() {
        ...
        List<ShopBusinessHour> hours = List.of(
            ShopBusinessHour.reconstitute(1L, 1L, DayType.DAILY, LocalTime.of(20, 0), LocalTime.of(2, 0), false, false)
        );
    ...
    void preparing_activeSuspension() {
        ...
        List<ShopSuspension> suspensions = List.of(
            ShopSuspension.reconstitute(1L, 1L, SuspensionReason.SHOP_CIRCUMSTANCE, null,
    ...
    void preparing_temporaryClosure() {
        ...
        List<ShopTemporaryClosure> closures = List.of(
            ShopTemporaryClosure.reconstitute(1L, 1L, LocalDate.of(2026, 7, 26), LocalDate.of(2026, 7, 28), null)
        );
    ...
    void preparing_everyMondayClosed() {
        ...
        List<ShopClosedDay> closedDays = List.of(
            ShopClosedDay.reconstitute(1L, 1L, ClosedDayType.EVERY_WEEK_MONDAY)
        );
    ...
    void fourthWeekMonday() {
        ...
        List<ShopClosedDay> closedDays = List.of(
            ShopClosedDay.reconstitute(1L, 1L, ClosedDayType.EVERY_MONTH_FOURTH_WEEK_MONDAY)
        );
    ...
    void preparing_withinBreakTime() {
        ...
        List<ShopBreakTime> breakTimes = List.of(
            ShopBreakTime.reconstitute(1L, 1L, DayType.DAILY, LocalTime.of(11, 30), LocalTime.of(13, 0))
        );
