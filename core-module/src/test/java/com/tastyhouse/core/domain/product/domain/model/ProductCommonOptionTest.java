...
class ProductCommonOptionTest {
    ...
    void of_createsTransientOption_withNullAdditionalPriceDefaultedToZero() {
        ProductCommonOption option = ProductCommonOption.of(1L, "곱빼기", null, 1, false, true);

        assertThat(option.getId()).isNull();
        assertThat(option.getOptionGroupId()).isEqualTo(1L);
    ...
    void update_changesFields() {
        ProductCommonOption option = ProductCommonOption.of(1L, "곱빼기", 1000, 1, false, true);
    ...
    void reconstitute_restoresPersistedState() {
        ProductCommonOption option = ProductCommonOption.reconstitute(1L, 10L, "곱빼기", 1000, 1, false, true);

        assertThat(option.getId()).isEqualTo(1L);
        assertThat(option.getOptionGroupId()).isEqualTo(10L);
    }
}
