...
public record AdminCreateCommand(
    ...
    public static AdminCreateCommand of(String username, String encodedPassword, String name, AdminRole role) {
        return new AdminCreateCommand(username, encodedPassword, name, role);
    }
}
