...
/**
 * 메뉴 ↔ 일반 옵션그룹 연결 JPA 영속 모델.
 *
 * <p>순수 도메인 모델 {@code ProductOptionGroupLink}와 분리된 영속 전용 엔티티다. 도메인↔엔티티 변환은
 * {@code ProductOptionGroupLinkMapper}가 수행한다.
 *
...
public class ProductOptionGroupLinkJpaEntity extends BaseEntity {
    ...
    /**
     * 신규 저장용 엔티티를 생성한다(식별자 없음). {@code ProductOptionGroupLinkMapper#toEntity}에서만 호출한다.
     */
