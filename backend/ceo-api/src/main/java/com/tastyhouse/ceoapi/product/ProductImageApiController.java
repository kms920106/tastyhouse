...
import com.tastyhouse.ceoapi.product.request.ProductImageSortRequest;
...
public class ProductImageApiController {
    ...
    public ProductImageApiController(
        ...
        ProductImageCommandService productImageCommandService
    ) {
    ...
    public ResponseEntity<ApiResponse<Long>> requestProductImage(
        ...
        Long requestId = productImageCommandService.requestImageChange(
            userDetails.getCeoId(), shopId, id, file
        );
    ...
    public ResponseEntity<ApiResponse<Void>> changeProductImageSort(
        ...
        productImageCommandService.reorderImages(
            userDetails.getCeoId(), request.shopId(), id, request.imageIds()
        );
    ...
    public ResponseEntity<ApiResponse<Void>> deleteProductImage(
        ...
        productImageCommandService.deleteImage(userDetails.getCeoId(), request.shopId(), imageId);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
