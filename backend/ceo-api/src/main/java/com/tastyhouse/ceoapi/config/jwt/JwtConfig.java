...
import com.tastyhouse.ceoapplication.auth.token.JwtTokenProvider;
import com.tastyhouse.security.jwt.JwtAuthenticationFilter;
import com.tastyhouse.security.token.BlacklistRedisRepository;

/**
 * security-module의 접두사 주입형/파라미터형 공용 JWT 컴포넌트를 ceo-api 전용 협력자로 빈 등록한다.
 * (JwtTokenProvider는 ceo-application의 ceo 전용 하위 클래스가 @Component로 자기 등록한다.)
 */
@Configuration
