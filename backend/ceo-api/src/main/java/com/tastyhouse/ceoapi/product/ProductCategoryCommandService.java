...
public class ProductCategoryCommandService {
    ...
    public Long createProductCategory(Long ceoId, Long shopId, String name, String description) {
     ...
     * 메뉴를 삭제해야 한다.
     */
    public void deleteProductCategory(Long ceoId, Long productCategoryId, Long shopId) {
        shopOwnershipValidator.validateOwnership(ceoId, shopId);
