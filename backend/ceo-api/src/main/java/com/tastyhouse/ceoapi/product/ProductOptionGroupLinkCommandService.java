...
@Service
@Transactional
public class ProductOptionGroupLinkCommandService {
    ...
    public void linkOptionGroup(Long ceoId, Long shopId, Long productId, Long optionGroupId) {
     ...
     * 보이지 않는 고아 그룹이 된다.
     */
    public void unlinkOptionGroup(Long ceoId, Long shopId, Long productId, Long optionGroupId) {
        shopOwnershipValidator.validateOwnership(ceoId, shopId);
        loadOwnedProduct(shopId, productId);
        productOptionGroupOwnershipValidator.validateOptionGroupShop(shopId, optionGroupId);
     ...
     */
    public void changeOptionGroupOrder(Long ceoId, Long shopId, Long productId, List<Long> optionGroupIds) {
        shopOwnershipValidator.validateOwnership(ceoId, shopId);
        loadOwnedProduct(shopId, productId);
