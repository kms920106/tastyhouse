...
import com.tastyhouse.ceoapi.review.request.ReviewBlindRequestCreateRequest;
...
public class ReviewBlindRequestApiController {
    ...
    public ReviewBlindRequestApiController(ReviewBlindRequestCommandService reviewBlindRequestCommandService) {
    ...
    public ResponseEntity<ApiResponse<Long>> createBlindRequest(
        ...
        Long blindRequestId = reviewBlindRequestCommandService.request(
    ...
    public ResponseEntity<ApiResponse<Void>> cancelBlindRequest(
        ...
        reviewBlindRequestCommandService.cancel(userDetails.getCeoId(), id, requestId);
