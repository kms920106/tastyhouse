...
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupMergeExclusionCreateRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupMergePreviewSearchRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupMergeRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupMergeSuggestionSearchRequest;
import com.tastyhouse.ceoapi.product.response.ProductOptionGroupMergePreviewResponse;
import com.tastyhouse.ceoapi.product.response.ProductOptionGroupMergeSuggestionResponse;
...
public class ProductOptionGroupMergeApiController {
    ...
    private final ProductOptionGroupMergeCommandService productOptionGroupMergeCommandService;

    public ProductOptionGroupMergeApiController(
        ProductOptionGroupMergeQueryService productOptionGroupMergeQueryService,
        ProductOptionGroupMergeCommandService productOptionGroupMergeCommandService
    ) {
        this.productOptionGroupMergeQueryService = productOptionGroupMergeQueryService;
        this.productOptionGroupMergeCommandService = productOptionGroupMergeCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Long>> excludeMergeSuggestion(
        ...
        Long exclusionId = productOptionGroupMergeCommandService.excludeMergeSuggestion(
    ...
    public ResponseEntity<ApiResponse<Long>> mergeProductOptionGroups(
        ...
        Long baseOptionGroupId = productOptionGroupMergeCommandService.mergeProductOptionGroups(
            userDetails.getCeoId(),
            request.shopId(),
            id,
            request.optionGroupIds(),
