...
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryAreaBulkRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryAreaCreateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryAreaPolygonSaveRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryAreaRadiusRequest;
...
import com.tastyhouse.ceoapi.shop.response.ShopDeliveryAreaPolygonPreviewResponse;
import com.tastyhouse.ceoapi.shop.response.ShopDeliveryAreaPolygonResponse;
import com.tastyhouse.ceoapi.shop.response.ShopDeliveryAreaRadiusPreviewResponse;
...
public class ShopDeliveryAreaApiController {
    ...
    public ShopDeliveryAreaApiController(
        ...
        ShopDeliveryAreaCommandService shopDeliveryAreaCommandService,
    ...
    public ResponseEntity<ApiResponse<ShopDeliveryAreaBulkResponse>> createDeliveryAreasBulk(
        ...
        ShopDeliveryAreaBulkResponse response = shopDeliveryAreaCommandService.addDeliveryAreas(
            userDetails.getCeoId(), id, request.adminDongIds()
        );
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<ShopDeliveryAreaBulkDeleteResponse>> deleteDeliveryAreasBulk(
        ...
        ShopDeliveryAreaBulkDeleteResponse response = shopDeliveryAreaCommandService.removeDeliveryAreas(
            userDetails.getCeoId(), id, request.adminDongIds()
        );
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<ShopDeliveryAreaBulkResponse>> applyRadius(
        ...
        ShopDeliveryAreaBulkResponse response = shopDeliveryAreaCommandService.applyRadius(
            userDetails.getCeoId(), id, request.radiusMeters(), request.replace()
        );
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> savePolygon(
        ...
        shopDeliveryAreaCommandService.savePolygon(userDetails.getCeoId(), id, request.rings());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePolygon(
        ...
        shopDeliveryAreaCommandService.deletePolygon(userDetails.getCeoId(), id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
