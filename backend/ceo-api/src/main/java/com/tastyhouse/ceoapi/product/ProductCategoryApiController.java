...
import com.tastyhouse.ceoapi.product.request.ProductCategoryCreateRequest;
import com.tastyhouse.ceoapi.product.request.ProductCategoryDeleteRequest;
import com.tastyhouse.ceoapi.product.request.ProductCategorySearchRequest;
import com.tastyhouse.ceoapi.product.request.ProductCategoryUpdateRequest;
...
public class ProductCategoryApiController {
    ...
    public ResponseEntity<ApiResponse<Long>> createProductCategory(
        ...
        Long productCategoryId = productCategoryCommandService.createProductCategory(
            userDetails.getCeoId(), request.shopId(), request.name(), request.description()
        );
    ...
    public ResponseEntity<ApiResponse<Void>> updateProductCategory(
        ...
        productCategoryCommandService.updateProductCategory(
            userDetails.getCeoId(), id, request.shopId(), request.name(), request.description()
        );
    ...
    public ResponseEntity<ApiResponse<Void>> deleteProductCategory(
        ...
        productCategoryCommandService.deleteProductCategory(userDetails.getCeoId(), id, request.shopId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
