...
import com.tastyhouse.ceoapi.shop.application.port.in.ShopDeliveryTipScheduleCommand;
...
public record ShopDeliveryTipSchedulesUpdateRequest(
    ...
    public ShopDeliveryTipSchedulesUpdateCommand toCommand(Long ceoId, Long shopId) {
        List<ShopDeliveryTipScheduleCommand> scheduleCommands = schedules().stream()
            ...
            .toList();
        return new ShopDeliveryTipSchedulesUpdateCommand(ceoId, shopId, scheduleCommands);
    }
}
