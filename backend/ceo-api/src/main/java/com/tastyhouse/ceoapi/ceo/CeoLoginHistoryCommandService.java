...
@Service
@Transactional
public class CeoLoginHistoryCommandService {
     ...
     * 로그인 성공 이력을 기록한다.
     */
    public void recordSuccess(Long ceoId, String ipAddress, String userAgent) {
        ceoLoginHistoryRecorder.recordSuccess(CeoId.of(ceoId), ipAddress, userAgent);
    }
    ...
    public void recordFailure(
        ...
        ceoLoginHistoryRecorder.recordFailure(CeoId.of(ceoId), failureReason, ipAddress, userAgent);
    }
}
