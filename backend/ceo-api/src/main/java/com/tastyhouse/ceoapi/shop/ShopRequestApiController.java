...
import com.tastyhouse.ceoapi.shop.request.ShopRequestCommentCreateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopRequestSearchRequest;
import com.tastyhouse.ceoapi.shop.response.ShopRequestCommentResponse;
...
public class ShopRequestApiController {
    ...
    private final ShopRequestCommandService shopRequestCommandService;

    public ShopRequestApiController(
        ShopRequestQueryService shopRequestQueryService,
        ShopRequestCommandService shopRequestCommandService
    ) {
        this.shopRequestQueryService = shopRequestQueryService;
        this.shopRequestCommandService = shopRequestCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> cancelRequest(
        ...
        shopRequestCommandService.cancelRequest(userDetails.getCeoId(), id, requestId);
    ...
    public ResponseEntity<ApiResponse<Long>> createComment(
        ...
        Long commentId = shopRequestCommandService.addComment(
            userDetails.getCeoId(),
            id,
            requestId,
            request.content()
