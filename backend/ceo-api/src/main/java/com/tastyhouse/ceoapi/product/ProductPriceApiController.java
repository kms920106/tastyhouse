...
import com.tastyhouse.ceoapi.product.request.ProductPriceReplaceRequest;
import com.tastyhouse.ceoapi.product.request.ProductShopScopeRequest;
import com.tastyhouse.ceoapi.product.response.ProductPriceResponse;
...
public class ProductPriceApiController {
    ...
    public ProductPriceApiController(
        ...
        ProductPriceCommandService productPriceCommandService
    ) {
    ...
    public ResponseEntity<ApiResponse<Void>> replacePrices(
        ...
        productPriceCommandService.replacePrices(
            userDetails.getCeoId(), request.shopId(), id, request.prices()
        );
