...
import com.tastyhouse.ceoapi.shop.request.ShopMinOrderAmountUpdateRequest;
...
public class ShopMinOrderAmountApiController {
    ...
    private final ShopMinOrderAmountCommandService shopMinOrderAmountCommandService;

    public ShopMinOrderAmountApiController(ShopMinOrderAmountCommandService shopMinOrderAmountCommandService) {
        this.shopMinOrderAmountCommandService = shopMinOrderAmountCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateMinOrderAmount(
        ...
        shopMinOrderAmountCommandService.updateMinOrderAmount(userDetails.getCeoId(), id, request.minOrderAmount());
