...
@Service
@Transactional
public class ShopRequestCommandService {
     ...
     * 점주가 대기중인 요청을 취소한다.
     */
    public void cancelRequest(Long ceoId, Long shopId, Long requestId) {
     ...
     * @return 생성된 댓글 식별자
     */
    public Long addComment(Long ceoId, Long shopId, Long requestId, String content) {
        shopOwnershipValidator.validateOwnership(ceoId, shopId);
