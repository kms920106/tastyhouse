...
import com.tastyhouse.ceoapi.shop.request.ShopRiderPickupLocationUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopRiderVisitGuideUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopRiderVisitGuideValidateRequest;
import com.tastyhouse.ceoapi.shop.response.ShopRiderGuideResponse;
import com.tastyhouse.ceoapi.shop.response.ShopRiderVisitGuideValidationResponse;
...
public class ShopRiderGuideApiController {
    ...
    private final ShopRiderGuideCommandService shopRiderGuideCommandService;

    public ShopRiderGuideApiController(ShopRiderGuideQueryService shopRiderGuideQueryService, ShopRiderGuideCommandService shopRiderGuideCommandService) {
        this.shopRiderGuideQueryService = shopRiderGuideQueryService;
        this.shopRiderGuideCommandService = shopRiderGuideCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateVisitGuide(
        ...
        shopRiderGuideCommandService.updateVisitGuide(userDetails.getCeoId(), id, request.visitGuide());
    ...
    public ResponseEntity<ApiResponse<Void>> clearPickupLocation(
        ...
        shopRiderGuideCommandService.clearPickupLocation(userDetails.getCeoId(), id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
