...
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryTipDistanceUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryTipHolidayUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryTipRegionsUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryTipSchedulesUpdateRequest;
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryTipTiersUpdateRequest;
import com.tastyhouse.ceoapi.shop.response.ShopDeliveryTipSettingResponse;
...
public class ShopDeliveryTipApiController {
    ...
    private final ShopDeliveryTipCommandService shopDeliveryTipCommandService;

    public ShopDeliveryTipApiController(ShopDeliveryTipQueryService shopDeliveryTipQueryService, ShopDeliveryTipCommandService shopDeliveryTipCommandService) {
        this.shopDeliveryTipQueryService = shopDeliveryTipQueryService;
        this.shopDeliveryTipCommandService = shopDeliveryTipCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateTiers(
        ...
        shopDeliveryTipCommandService.updateTiers(userDetails.getCeoId(), id, request.tiers());
    ...
    public ResponseEntity<ApiResponse<Void>> updateDistanceTip(
        ...
        shopDeliveryTipCommandService.updateDistanceTip(userDetails.getCeoId(), id, request.baseDistanceMeters(), request.surchargeUnit(), request.surchargeAmount());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> removeDistanceTip(
        ...
        shopDeliveryTipCommandService.removeDistanceTip(userDetails.getCeoId(), id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateRegionTips(
        ...
        shopDeliveryTipCommandService.updateRegionTips(userDetails.getCeoId(), id, request.regions());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> removeRegionTips(
        ...
        shopDeliveryTipCommandService.removeRegionTips(userDetails.getCeoId(), id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateScheduleTips(
        ...
        shopDeliveryTipCommandService.updateScheduleTips(userDetails.getCeoId(), id, request.schedules());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateHolidayTip(
        ...
        shopDeliveryTipCommandService.updateHolidayTip(userDetails.getCeoId(), id, request.tipAmount());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
