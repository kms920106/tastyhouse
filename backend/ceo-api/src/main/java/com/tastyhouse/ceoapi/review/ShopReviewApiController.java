...
import com.tastyhouse.ceoapi.review.request.ShopReviewSearchRequest;
import com.tastyhouse.ceoapi.review.request.ShopReviewSortTypeUpdateRequest;
...
public class ShopReviewApiController {
    ...
    private final ShopReviewCommandService shopReviewCommandService;

    public ShopReviewApiController(
        ShopReviewQueryService shopReviewQueryService,
        ShopReviewCommandService shopReviewCommandService
    ) {
        this.shopReviewQueryService = shopReviewQueryService;
        this.shopReviewCommandService = shopReviewCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> changeSortType(
        ...
        shopReviewCommandService.changeSortType(userDetails.getCeoId(), id, request.sortType());
