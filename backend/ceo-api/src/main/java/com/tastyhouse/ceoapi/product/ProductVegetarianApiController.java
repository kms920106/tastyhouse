...
import com.tastyhouse.ceoapi.product.request.ProductVegetarianRequest;
...
public class ProductVegetarianApiController {
    ...
    private final ProductVegetarianCommandService productVegetarianCommandService;

    public ProductVegetarianApiController(
        ProductVegetarianQueryService productVegetarianQueryService,
        ProductVegetarianCommandService productVegetarianCommandService
    ) {
        this.productVegetarianQueryService = productVegetarianQueryService;
        this.productVegetarianCommandService = productVegetarianCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Long>> requestProductVegetarian(
        ...
        Long requestId = productVegetarianCommandService.requestVegetarian(
            userDetails.getCeoId(), request.shopId(), id,
            request.vegetarianType(), request.ingredients(), request.description()
        );
    ...
    public ResponseEntity<ApiResponse<Void>> clearProductVegetarian(
        ...
        productVegetarianCommandService.clearVegetarian(userDetails.getCeoId(), request.shopId(), id);
