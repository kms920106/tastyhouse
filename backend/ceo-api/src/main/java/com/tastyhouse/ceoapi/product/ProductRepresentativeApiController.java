...
import com.tastyhouse.ceoapi.product.request.ProductRepresentativeCreateRequest;
...
public class ProductRepresentativeApiController {
    ...
    private final ProductRepresentativeCommandService productRepresentativeCommandService;

    public ProductRepresentativeApiController(
        ProductRepresentativeCommandService productRepresentativeCommandService
    ) {
        this.productRepresentativeCommandService = productRepresentativeCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<List<Long>>> requestRepresentative(
        ...
        List<Long> requestIds = productRepresentativeCommandService.requestRepresentative(
    ...
    public ResponseEntity<ApiResponse<Void>> clearRepresentative(
        ...
        productRepresentativeCommandService.clearRepresentative(userDetails.getCeoId(), request.shopId(), id);
