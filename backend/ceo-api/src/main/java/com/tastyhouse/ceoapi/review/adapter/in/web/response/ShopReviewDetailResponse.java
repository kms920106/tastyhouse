...
public record ShopReviewDetailResponse(
    ...
    public static ShopReviewDetailResponse from(ShopReviewDetailViewResult view) {
        ...
        List<ReviewBlindRequestHistoryResponse> blindRequests = result.blindRequests().stream()
            ...
            .toList();
        ReviewBlindRequestHistoryResponse latest = blindRequests.isEmpty() ? null : blindRequests.getFirst();
        return new ShopReviewDetailResponse(
            result.id(),
            ShopReviewListItemResponse.toReviewNumber(result.id()),
            ...
            latest == null ? null : latest.statusDescription(),
            blindRequests,
            result.createdAt(),
