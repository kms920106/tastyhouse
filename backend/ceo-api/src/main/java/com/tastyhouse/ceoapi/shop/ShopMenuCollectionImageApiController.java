...
import com.tastyhouse.ceoapi.shop.request.ShopMenuCollectionImageOrderRequest;
...
public class ShopMenuCollectionImageApiController {
    ...
    private final ShopMenuCollectionImageCommandService shopMenuCollectionImageCommandService;

    public ShopMenuCollectionImageApiController(
        ShopMenuCollectionImageQueryService shopMenuCollectionImageQueryService,
        ShopMenuCollectionImageCommandService shopMenuCollectionImageCommandService
    ) {
        this.shopMenuCollectionImageQueryService = shopMenuCollectionImageQueryService;
        this.shopMenuCollectionImageCommandService = shopMenuCollectionImageCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Long>> registerMenuCollectionImage(
        ...
        Long imageId = shopMenuCollectionImageCommandService.registerMenuCollectionImage(
            userDetails.getCeoId(), id, file
        );
    ...
    public ResponseEntity<ApiResponse<Void>> changeMenuCollectionImageOrder(
        ...
        shopMenuCollectionImageCommandService.reorderMenuCollectionImages(
            userDetails.getCeoId(), id, request.imageIds()
        );
    ...
    public ResponseEntity<ApiResponse<Void>> deleteMenuCollectionImage(
        ...
        shopMenuCollectionImageCommandService.deleteMenuCollectionImage(userDetails.getCeoId(), id, imageId);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
