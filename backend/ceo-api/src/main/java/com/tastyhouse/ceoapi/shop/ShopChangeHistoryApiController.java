...
import com.tastyhouse.ceoapi.shop.request.ShopChangeHistorySearchRequest;
import com.tastyhouse.ceoapi.shop.response.ShopChangeCategoryResponse;
import com.tastyhouse.ceoapi.shop.response.ShopChangeHistoryListItemResponse;
...
public class ShopChangeHistoryApiController {
    ...
    public ResponseEntity<ApiResponse<List<ShopChangeHistoryListItemResponse>>> getChangeHistories(
        ...
        PaginationResponse<ShopChangeHistoryListItemResponse> response =
            shopChangeHistoryQueryService.getChangeHistories(
    ...
    public ResponseEntity<ApiResponse<List<ShopChangeCategoryResponse>>> getChangeHistoryTypes() {
        List<ShopChangeCategoryResponse> response = shopChangeHistoryQueryService.getChangeHistoryTypes();
