...
import com.tastyhouse.ceoapi.ceo.request.CeoReplyPhraseCreateRequest;
import com.tastyhouse.ceoapi.ceo.response.CeoReplyPhraseResponse;
...
public class CeoReplyPhraseApiController {
    ...
    private final CeoReplyPhraseCommandService ceoReplyPhraseCommandService;
    private final CeoReplyPhraseQueryService ceoReplyPhraseQueryService;

    public CeoReplyPhraseApiController(
        CeoReplyPhraseCommandService ceoReplyPhraseCommandService,
        CeoReplyPhraseQueryService ceoReplyPhraseQueryService
    ) {
        this.ceoReplyPhraseCommandService = ceoReplyPhraseCommandService;
    ...
    public ResponseEntity<ApiResponse<Long>> createReplyPhrase(
        ...
        Long replyPhraseId = ceoReplyPhraseCommandService.register(
    ...
    public ResponseEntity<ApiResponse<Void>> updateReplyPhrase(
        ...
        ceoReplyPhraseCommandService.modify(
            userDetails.getCeoId(),
            id,
            request.name(),
            request.content()
    ...
    public ResponseEntity<ApiResponse<Void>> deleteReplyPhrase(
        ...
        ceoReplyPhraseCommandService.remove(userDetails.getCeoId(), id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
