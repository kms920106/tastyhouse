...
import com.tastyhouse.ceoapi.shop.request.ShopOriginInfoUpdateRequest;
...
public class ShopOriginInfoApiController {
    ...
    private final ShopOriginInfoCommandService shopOriginInfoCommandService;

    public ShopOriginInfoApiController(ShopOriginInfoQueryService shopOriginInfoQueryService, ShopOriginInfoCommandService shopOriginInfoCommandService) {
        this.shopOriginInfoQueryService = shopOriginInfoQueryService;
        this.shopOriginInfoCommandService = shopOriginInfoCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateOriginInfo(
        ...
        shopOriginInfoCommandService.updateOriginInfo(
