...
@Service
@Transactional
public class CeoReplyPhraseCommandService {
    ...
    public Long register(Long ceoId, String name, String content) {
        return ceoReplyPhraseService.register(ceoId, name, content);
    }
    ...
    public void modify(Long ceoId, Long phraseId, String name, String content) {
        ceoReplyPhraseService.modify(ceoId, phraseId, name, content);
    }
    ...
    public void remove(Long ceoId, Long phraseId) {
        ceoReplyPhraseService.remove(ceoId, phraseId);
    }
}
