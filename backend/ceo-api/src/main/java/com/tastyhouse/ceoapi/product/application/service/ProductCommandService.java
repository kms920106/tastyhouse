...
import com.tastyhouse.ceoapi.product.ProductNameValidator;
import com.tastyhouse.ceoapi.product.adapter.in.web.response.ProductAvailabilityChangeResponse;
import com.tastyhouse.ceoapi.product.adapter.in.web.response.ProductAvailabilityFailureResponse;
...
@Service
@Transactional
public class ProductCommandService implements ProductCreateUseCase, ProductUpdateUseCase, ProductDeleteUseCase {
