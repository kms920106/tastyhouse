...
public class ProductImageCommandService {
     ...
     */
    public Long requestImageChange(Long ceoId, Long shopId, Long productId, MultipartFile file) {
     ...
     * 배치가 아니다.
     */
    public void reorderImages(Long ceoId, Long shopId, Long productId, List<Long> imageIds) {
        requireOwnedProduct(ceoId, shopId, productId);
     ...
     */
    public void deleteImage(Long ceoId, Long shopId, Long imageId) {
