...
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupCreateRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupDeleteRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupSearchRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionGroupUpdateRequest;
import com.tastyhouse.ceoapi.product.response.ProductOptionGroupResponse;
...
public class ProductOptionGroupApiController {
    ...
    private final ProductOptionGroupCommandService productOptionGroupCommandService;

    public ProductOptionGroupApiController(
        ProductOptionGroupQueryService productOptionGroupQueryService,
        ProductOptionGroupCommandService productOptionGroupCommandService
    ) {
        this.productOptionGroupQueryService = productOptionGroupQueryService;
        this.productOptionGroupCommandService = productOptionGroupCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Long>> createProductOptionGroup(
        ...
        Long optionGroupId = productOptionGroupCommandService.createProductOptionGroup(
    ...
    public ResponseEntity<ApiResponse<Void>> updateProductOptionGroup(
        ...
        productOptionGroupCommandService.updateProductOptionGroup(
            userDetails.getCeoId(),
            id,
            request.shopId(),
            request.name(),
    ...
    public ResponseEntity<ApiResponse<Void>> deleteProductOptionGroup(
        ...
        productOptionGroupCommandService.deleteProductOptionGroup(userDetails.getCeoId(), id, request.shopId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
