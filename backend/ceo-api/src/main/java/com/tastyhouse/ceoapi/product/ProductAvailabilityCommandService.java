...
@Service
@Transactional
public class ProductAvailabilityCommandService {
     ...
     */
    public ProductAvailabilityChangeResponse markProductsSoldOut(
        Long ceoId,
        Long shopId,
    ...
    public ProductAvailabilityChangeResponse hideProducts(Long ceoId, Long shopId, List<Long> productIds) {
        shopOwnershipValidator.validateOwnership(ceoId, shopId);
        return toChangeResponse(productAvailabilityService.hideProducts(ShopId.of(shopId), toProductIds(productIds)));
    }

    public ProductAvailabilityChangeResponse releaseProducts(
        Long ceoId,
        Long shopId,
        List<Long> productIds,
        String target
    ...
    public ProductAvailabilityChangeResponse changeProductsSoldOutUntil(
        Long ceoId,
        Long shopId,
        List<Long> productIds,
        LocalDateTime soldOutUntil
     ...
     */
    public ProductAvailabilityChangeResponse markOptionsSoldOut(
        Long ceoId,
        Long shopId,
        List<Long> optionIds,
    ...
    public ProductAvailabilityChangeResponse hideOptions(
        Long ceoId,
        Long shopId,
        List<Long> optionIds,
        List<String> optionTypes
    ...
    public ProductAvailabilityChangeResponse releaseOptions(
        Long ceoId,
        Long shopId,
        List<Long> optionIds,
        List<String> optionTypes,
    ...
    public ProductAvailabilityChangeResponse changeOptionsSoldOutUntil(
        Long ceoId,
        Long shopId,
        List<Long> optionIds,
        List<String> optionTypes,
