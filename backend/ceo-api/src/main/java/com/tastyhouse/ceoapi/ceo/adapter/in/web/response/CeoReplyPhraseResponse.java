...
public record CeoReplyPhraseResponse(
     ...
     *
     * <p><b>챕터 09</b> — 파생 위치를 QueryService에서 이 표현 계약으로 옮겼다. "이름이 비면 내용
     * 앞부분을 보여준다"는 <b>화면 규칙</b>이지 도메인 불변식이 아니고(파생값을 저장하면 내용 수정 시
     * 어긋난다), 표현 규칙은 표현 계층이 소유하는 것이 계층 경계에 맞기 때문이다. application은
     * {@code CeoReplyPhraseResult}를 그대로 흘려보낸다.
     */
