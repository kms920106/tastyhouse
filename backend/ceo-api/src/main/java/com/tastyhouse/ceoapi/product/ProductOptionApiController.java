...
import com.tastyhouse.ceoapi.product.request.ProductOptionCreateRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionDeleteRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionSortRequest;
import com.tastyhouse.ceoapi.product.request.ProductOptionUpdateRequest;
...
public class ProductOptionApiController {
    ...
    public ProductOptionApiController(ProductOptionCommandService productOptionCommandService) {
    ...
    public ResponseEntity<ApiResponse<Long>> createProductOption(
        ...
        Long optionId = productOptionCommandService.createProductOption(
    ...
    public ResponseEntity<ApiResponse<Void>> updateProductOption(
        ...
        productOptionCommandService.updateProductOption(
            userDetails.getCeoId(),
            id,
            request.shopId(),
            request.name(),
    ...
    public ResponseEntity<ApiResponse<Void>> deleteProductOption(
        ...
        productOptionCommandService.deleteProductOption(userDetails.getCeoId(), id, request.shopId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> changeProductOptionOrder(
        ...
        productOptionCommandService.changeProductOptionOrder(
            userDetails.getCeoId(), request.shopId(), optionGroupId, request.optionIds()
        );
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
