...
import com.tastyhouse.ceoapi.shop.request.ShopDeliveryAreaAdjustmentCreateRequest;
import com.tastyhouse.ceoapi.shop.response.ShopDeliveryAreaAdjustmentItemResponse;
...
public class ShopDeliveryAreaAdjustmentApiController {
    ...
    public ResponseEntity<ApiResponse<Long>> requestAdjustment(
        ...
        Long requestId = shopDeliveryAreaAdjustmentCommandService.requestAdjustment(
            userDetails.getCeoId(),
            id,
            request.counterpartShopName(),
            request.counterpartBusinessNumber(),
