 ...
 * {@link ProductSoldOutReleaseSchedulerService}에 둔다.
 */
@Component
public class ProductSoldOutReleaseScheduler {
    ...
    private final ProductSoldOutReleaseSchedulerService productSoldOutReleaseSchedulerService;

    public ProductSoldOutReleaseScheduler(
        ProductSoldOutReleaseSchedulerService productSoldOutReleaseSchedulerService
    ) {
        this.productSoldOutReleaseSchedulerService = productSoldOutReleaseSchedulerService;
    }
    ...
    public void releaseExpiredSoldOut() {
        ...
        try {
            productSoldOutReleaseSchedulerService.releaseExpiredSoldOut();
