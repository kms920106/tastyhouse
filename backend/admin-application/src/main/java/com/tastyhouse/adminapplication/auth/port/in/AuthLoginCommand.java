package com.tastyhouse.adminapplication.auth.port.in;
...
public record AuthLoginCommand(
    ...
    public static AuthLoginCommand of(String username, String password, boolean rememberMe) {
        return new AuthLoginCommand(username, password, rememberMe);
    }
}
