 ...
 * 원칙을 지켰는지가 사람 눈에만 의존한다. 이 테스트가 그 지점을 자동화한다 — 챕터 03로 클래스가
...
class RuleAnchorTest {
     ...
     *
     * <p>이 계약들은 {@code com.tastyhouse.adminapplication}이 아니라 split package인
    ...
    void readContractsExist() {
        assertThat(readContracts.stream()
            ...
            .count())
            .as("admin 단독 읽기 계약이 0건이면 프레임워크-프리 규칙이 공허하게 통과한다")
