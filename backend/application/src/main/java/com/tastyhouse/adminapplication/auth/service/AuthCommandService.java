package com.tastyhouse.adminapplication.auth.service;
 ...
 *
 * <p>이 서비스와 {@link TokenService}는 web-api의 동명 타입과 <b>의도적으로 중복</b>된다 —
...
public class AuthCommandService implements AuthCommandUseCase {
    ...
    public AuthCommandService(AuthenticationManager authenticationManager, TokenService tokenService) {
