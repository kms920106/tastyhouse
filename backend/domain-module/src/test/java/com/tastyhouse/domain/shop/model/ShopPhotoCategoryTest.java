...
class ShopPhotoCategoryTest {
    ...
    void of_createsTransientPhotoCategory() {
        ShopPhotoCategory photoCategory = ShopPhotoCategory.of(ShopId.of(1L), "가게 외관");

        assertThat(photoCategory.getId()).isNull();
        assertThat(photoCategory.getShopId()).isEqualTo(ShopId.of(1L));
    ...
    void reconstitute_restoresPersistedState() {
        ShopPhotoCategory photoCategory = ShopPhotoCategory.reconstitute(1L, ShopId.of(2L), "가게 외관");

        assertThat(photoCategory.getId()).isEqualTo(1L);
        assertThat(photoCategory.getShopId()).isEqualTo(ShopId.of(2L));
    }
}
