...
import com.tastyhouse.adminapi.shop.request.ShopRiderGuideSearchRequest;
import com.tastyhouse.adminapi.shop.request.ShopRiderPickupLocationUpdateRequest;
import com.tastyhouse.adminapi.shop.request.ShopRiderVisitGuideDeleteRequest;
import com.tastyhouse.adminapi.shop.request.ShopRiderVisitGuideRevisionRequest;
...
public class ShopRiderGuideAdminApiController {
    ...
    public ShopRiderGuideAdminApiController(ShopRiderGuideQueryService shopRiderGuideQueryService, ShopRiderGuideCommandService shopRiderGuideCommandService) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteVisitGuide(
        ...
        shopRiderGuideCommandService.deleteVisitGuide(id, userDetails.getPrincipalId(), request.reason());
    ...
    public ResponseEntity<ApiResponse<Long>> requestRevision(
        ...
        Long historyId = shopRiderGuideCommandService.requestRevision(id, userDetails.getPrincipalId(), request.reason());
