...
public class ShopDeliveryAreaAdjustmentCommandService {
    ...
    public ShopDeliveryAreaAdjustmentCommandService(ShopDeliveryAreaAdjustmentService shopDeliveryAreaAdjustmentService) {
     ...
     */
    public void changeStatus(Long requestId, String status) {
    ...
    public void rejectAdjustment(Long requestId, String reason) {
