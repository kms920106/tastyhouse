...
import com.tastyhouse.adminapi.shop.request.ShopMenuCollectionImageRejectRequest;
import com.tastyhouse.adminapi.shop.request.ShopMenuCollectionImageSearchRequest;
...
public class ShopMenuCollectionImageAdminApiController {
    ...
    public ResponseEntity<ApiResponse<Void>> approveMenuCollectionImage(@PathVariable Long id) {
        shopMenuCollectionImageCommandService.approveMenuCollectionImage(id);
    ...
    public ResponseEntity<ApiResponse<Void>> rejectMenuCollectionImage(
        ...
        shopMenuCollectionImageCommandService.rejectMenuCollectionImage(id, request.rejectReason());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
