...
public record BugReportDetailResponse(
    ...
    public static BugReportDetailResponse from(BugReportDetailWithMemberResult result) {
        ...
        return new BugReportDetailResponse(
            ...
            bugReport.assigneeAdminId(),
            bugReport.adminAnswer(),
            bugReport.resolvedAt(),
            bugReport.appVersion(),
            bugReport.platform() != null ? bugReport.platform().name() : null,
            bugReport.osVersion(),
            toFileResponses(bugReport.images()),
            bugReport.createdAt(),
            bugReport.updatedAt()
        );
    }
