...
import com.tastyhouse.adminapi.shop.request.ShopDeliveryAreaAdjustmentRejectRequest;
import com.tastyhouse.adminapi.shop.request.ShopDeliveryAreaAdjustmentSearchRequest;
import com.tastyhouse.adminapi.shop.request.ShopDeliveryAreaAdjustmentStatusChangeRequest;
import com.tastyhouse.adminapi.shop.response.ShopDeliveryAreaAdjustmentDetailResponse;
import com.tastyhouse.adminapi.shop.response.ShopDeliveryAreaAdjustmentListItemResponse;
...
public class ShopDeliveryAreaAdjustmentAdminApiController {
    ...
    private final ShopDeliveryAreaAdjustmentCommandService shopDeliveryAreaAdjustmentCommandService;
    ...
    public ShopDeliveryAreaAdjustmentAdminApiController(
        ...
        ShopDeliveryAreaAdjustmentCommandService shopDeliveryAreaAdjustmentCommandService
    ) {
        this.shopDeliveryAreaAdjustmentQueryService = shopDeliveryAreaAdjustmentQueryService;
        this.shopDeliveryAreaAdjustmentCommandService = shopDeliveryAreaAdjustmentCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<List<ShopDeliveryAreaAdjustmentListItemResponse>>> getAdjustmentRequests(
        ...
        PaginationResponse<ShopDeliveryAreaAdjustmentListItemResponse> pageResponse = shopDeliveryAreaAdjustmentQueryService.getAdjustmentRequests(
    ...
    public ResponseEntity<ApiResponse<ShopDeliveryAreaAdjustmentDetailResponse>> getAdjustmentRequest(@PathVariable Long requestId) {
        ShopDeliveryAreaAdjustmentDetailResponse response = shopDeliveryAreaAdjustmentQueryService.getAdjustmentRequest(requestId);
    ...
    public ResponseEntity<ApiResponse<Void>> changeAdjustmentStatus(
        ...
        shopDeliveryAreaAdjustmentCommandService.changeStatus(requestId, request.status());
    ...
    public ResponseEntity<ApiResponse<Void>> rejectAdjustment(
        ...
        shopDeliveryAreaAdjustmentCommandService.rejectAdjustment(requestId, request.reason());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
