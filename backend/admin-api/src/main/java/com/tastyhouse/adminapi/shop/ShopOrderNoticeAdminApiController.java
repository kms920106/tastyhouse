...
import com.tastyhouse.adminapi.shop.request.ShopOrderNoticeHideRequest;
import com.tastyhouse.adminapi.shop.response.ShopOrderNoticeResponse;
...
public class ShopOrderNoticeAdminApiController {
    ...
    public ResponseEntity<ApiResponse<Void>> hideOrderNotice(
        ...
        shopOrderNoticeCommandService.hideOrderNotice(id, request.reason());
    ...
    public ResponseEntity<ApiResponse<Void>> unhideOrderNotice(@PathVariable Long id) {
        shopOrderNoticeCommandService.unhideOrderNotice(id);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
