package com.tastyhouse.webapplication.auth.service.facebook;
...
public class FacebookSocialLoginService {
    ...
    @Transactional
    public JwtResult signUp(String facebookTempToken, String username, String nickname, String fullName,
