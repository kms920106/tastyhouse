...
import com.tastyhouse.webapi.product.request.ProductFeedbackCreateRequest;
...
public class ProductFeedbackApiController {
    ...
    private final ProductFeedbackCommandService productFeedbackCommandService;

    public ProductFeedbackApiController(ProductFeedbackCommandService productFeedbackCommandService) {
        this.productFeedbackCommandService = productFeedbackCommandService;
    }
    ...
    public ResponseEntity<ApiResponse<Long>> createFeedback(
        ...
        Long feedbackId = productFeedbackCommandService.submitFeedback(
            userDetails.getMemberId(), id, request.feedbackType(), request.content()
        );
