...
public final class PublicPaths {
    ...
    public static final String[] PATTERNS = {
        ...
        "/api/shops/v1/map/markers", "/api/shops/v1/best", "/api/shops/v1/editor-choice", "/api/shops/v1/latest", "/api/shops/v1/stations", "/api/shops/v1/food-types", "/api/shops/v1/amenities", "/api/shops/v1/*", "/api/shops/v1/*/info", "/api/shops/v1/*/notice", "/api/shops/v1/*/order-notice", "/api/shops/v1/*/origin", "/api/shops/v1/*/price-badges", "/api/shops/v1/*/banners", "/api/shops/v1/*/menu-collection-images", "/api/shops/v1/*/products", "/api/shops/v1/*/popular-products", "/api/shops/v1/*/photos", "/api/shops/v1/*/reviews", "/api/shops/v1/*/reviews/statistics", "/api/shops/v1/*/bookmark", "/api/shops/v1/*/order-methods", "/api/shops/v1/*/delivery-tip", "/api/shops/v1/*/scheduled-order-slots",
        "/api/policies/**",
        "/api/products/**",
