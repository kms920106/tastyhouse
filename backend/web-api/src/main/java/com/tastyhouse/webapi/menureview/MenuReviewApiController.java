...
import com.tastyhouse.webapi.menureview.request.MenuReviewCreateRequest;
import com.tastyhouse.webapi.menureview.request.MenuReviewUpdateRequest;
import com.tastyhouse.webapi.menureview.response.MenuReviewListItemResponse;
import com.tastyhouse.webapi.menureview.response.MenuReviewWritableItemResponse;
...
public class MenuReviewApiController {
    ...
    private final MenuReviewCommandService menuReviewCommandService;
    private final MenuReviewQueryService menuReviewQueryService;

    public MenuReviewApiController(
        MenuReviewCommandService menuReviewCommandService,
        MenuReviewQueryService menuReviewQueryService
    ) {
        this.menuReviewCommandService = menuReviewCommandService;
    ...
    public ResponseEntity<ApiResponse<Long>> createMenuReview(
        ...
        Long menuReviewId = menuReviewCommandService.createMenuReview(
    ...
    public ResponseEntity<ApiResponse<Void>> updateMenuReview(
        ...
        menuReviewCommandService.updateMenuReview(
            id,
            userDetails.getMemberId(),
            request.rating(),
            request.comment()
    ...
    public ResponseEntity<ApiResponse<Void>> deleteMenuReview(
        ...
        menuReviewCommandService.deleteMenuReview(id, userDetails.getMemberId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
