...
public class AuthApiController {
    ...
    public ResponseEntity<ApiResponse<Long>> signUp(@Valid @RequestBody SignUpRequest request) {
        Long memberId = authCommandService.signUp(request.toCommand());
    ...
    public ResponseEntity<ApiResponse<AuthJwtResponse>> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        return ResponseEntity.ok(ApiResponse.success(AuthJwtResponse.from(authCommandService.login(loginRequest.username(), loginRequest.password(), loginRequest.rememberMe()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthJwtResponse>> refreshToken(@Valid @RequestBody RefreshTokenRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthJwtResponse.from(authCommandService.refresh(request.refreshToken()))));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> logout(@RequestHeader("Authorization") String bearerToken) {
        authCommandService.logout(bearerToken);
    ...
    public ResponseEntity<ApiResponse<Void>> requestPasswordReset(@Valid @RequestBody PasswordResetRequestRequest request) {
        authCommandService.sendPasswordResetCode(request.username());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<AuthPasswordResetTokenResponse>> verifyPasswordReset(@Valid @RequestBody PasswordResetVerifyRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthPasswordResetTokenResponse.from(authCommandService.verifyPasswordResetCode(request.username(), request.verificationCode()))));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> confirmPasswordReset(@Valid @RequestBody PasswordResetConfirmRequest request) {
        authCommandService.resetPassword(request.passwordResetToken(), request.newPassword(), request.newPasswordConfirm());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<AuthPhoneLoginResponse>> phoneLogin(@Valid @RequestBody PhoneLoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthPhoneLoginResponse.from(authCommandService.phoneLogin(request.smsVerifyToken()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthSocialLoginResponse>> kakaoLogin(@Valid @RequestBody KakaoLoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthSocialLoginResponse.from(authCommandService.kakaoLogin(request.code()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthSocialLoginResponse>> naverLogin(@Valid @RequestBody NaverLoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthSocialLoginResponse.from(authCommandService.naverLogin(request.code(), request.state()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthSocialLoginResponse>> facebookLogin(@Valid @RequestBody FacebookLoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthSocialLoginResponse.from(authCommandService.facebookLogin(request.accessToken()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthSocialLoginResponse>> appleLogin(@Valid @RequestBody AppleLoginRequest request) {
        return ResponseEntity.ok(ApiResponse.success(AuthSocialLoginResponse.from(authCommandService.appleLogin(request.code()))));
    }
    ...
    public ResponseEntity<ApiResponse<AuthSocialLinkResponse>> linkSocialAccount(@Valid @RequestBody SocialAccountLinkRequest request) {
        return ResponseEntity.ok(ApiResponse.success(
            AuthSocialLinkResponse.from(authCommandService.linkAccount(request.provider(), request.tempToken(), request.smsVerifyToken()))
        ));
    }
    ...
    public ResponseEntity<ApiResponse<AuthJwtResponse>> signUpSocialAccount(@Valid @RequestBody SocialSignUpRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success(
            AuthJwtResponse.from(authCommandService.socialSignUp(request.toCommand()))
        ));
    }
}
