...
import com.tastyhouse.webapi.review.response.ReviewBlindNoticeResponse;
...
public class ReviewBlindConsentApiController {
    ...
    private final ReviewBlindConsentCommandService reviewBlindConsentCommandService;
    private final ReviewBlindConsentQueryService reviewBlindConsentQueryService;

    public ReviewBlindConsentApiController(
        ReviewBlindConsentCommandService reviewBlindConsentCommandService,
        ReviewBlindConsentQueryService reviewBlindConsentQueryService
    ) {
        this.reviewBlindConsentCommandService = reviewBlindConsentCommandService;
    ...
    public ResponseEntity<ApiResponse<Void>> consentToDelete(
        ...
        reviewBlindConsentCommandService.consent(reviewId, userDetails.getMemberId());
    ...
    public ResponseEntity<ApiResponse<Void>> rejectDeletion(
        ...
        reviewBlindConsentCommandService.reject(reviewId, userDetails.getMemberId());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
