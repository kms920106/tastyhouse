...
public record ShopPriceBadgeResponse(
    ...
    public static ShopPriceBadgeResponse from(boolean sameAsStorePrice, boolean storePricePickup) {
        return new ShopPriceBadgeResponse(sameAsStorePrice, storePricePickup);
    }
}
