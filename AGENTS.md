...
A modern admin dashboard starter built with Next.js 16 (App Router), TypeScript, Tailwind CSS v4, and shadcn/ui. It ships multiple prebuilt dashboards (Default, CRM, Finance, Analytics, Productivity, E-commerce, Academy, Logistics), authentication layouts, chat/mail pages, and customizable theme presets with light/dark modes and layout controls. Synced from the `next-shadcn-admin-dashboard` template and rebranded as **Tastyhouse CEO**.

## Key Files

| File                    | Description                                                                            |
| ----------------------- | -------------------------------------------------------------------------------------- |
| `package.json`          | Dependencies, scripts, and template provenance. Dev/start server runs on port **3020** |
