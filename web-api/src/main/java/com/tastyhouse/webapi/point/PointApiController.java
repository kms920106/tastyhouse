...
import com.tastyhouse.webapi.point.service.PointService;
...
public class PointApiController {
    ...
    public ResponseEntity<ApiResponse<PointResponse>> getMyPoint(
        ...
        return ResponseEntity.ok(ApiResponse.success(pointService.getMemberPoint(userDetails.getMemberId())));
    }
    ...
    public ResponseEntity<ApiResponse<PointHistoryResponse>> getMyPointHistory(
        ...
        return ResponseEntity.ok(ApiResponse.success(pointService.getPointHistory(userDetails.getMemberId())));
    }
    ...
    public ResponseEntity<ApiResponse<PointUsableResponse>> getMyUsablePoint(
        ...
        return ResponseEntity.ok(ApiResponse.success(pointService.getUsablePoint(userDetails.getMemberId())));
    }
}
