...
import com.tastyhouse.webapi.mail.request.MailVerificationConfirmRequest;
import com.tastyhouse.webapi.mail.request.MailVerificationSendRequest;
import com.tastyhouse.webapi.mail.response.MailVerificationTokenResponse;
...
public class MailVerificationApiController {
    ...
    public ResponseEntity<ApiResponse<Void>> sendVerificationCode(
        ...
        mailVerificationCommandService.sendVerificationCode(request.email());
    ...
    public ResponseEntity<ApiResponse<MailVerificationTokenResponse>> confirmVerificationCode(
        ...
        String email = mailVerificationCommandService.confirmVerificationCode(request.email(), request.verificationCode());
