...
const SKELETON_COLUMNS = [
  ...
  { id: "shopName", header: "매장", width: 160, align: "left" },
  { id: "name", header: "상품명", width: 240, align: "left" },
  { id: "price", header: "가격", width: 160, align: "left" },
  { id: "badges", header: "상태", width: 200, align: "left" },
  { id: "sort", header: "정렬", width: 80, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `product-row-skeleton-${index}`).map(
                  (key) => (
