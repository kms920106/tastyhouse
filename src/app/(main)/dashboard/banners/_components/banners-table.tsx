...
import type { BannersTableMeta } from "./banners-columns";
...
export function BannersTable({ table, isPending }: { table: TableType<BannerListItem>; isPending: boolean }) {
  ...
  const totalElements = (table.options.meta as BannersTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `banner-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="banners-rows-per-page">
