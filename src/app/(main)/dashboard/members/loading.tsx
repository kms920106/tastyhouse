...
const SKELETON_COLUMNS = [
  { id: "id", header: "ID", width: 70, align: "left" },
  { id: "nickname", header: "닉네임", width: 140, align: "left" },
  { id: "username", header: "아이디", width: 140, align: "left" },
  { id: "fullName", header: "실명", width: 100, align: "left" },
  { id: "phoneNumber", header: "휴대폰번호", width: 140, align: "left" },
  { id: "gender", header: "성별", width: 70, align: "left" },
  { id: "memberGrade", header: "등급", width: 100, align: "left" },
  { id: "memberStatus", header: "상태", width: 90, align: "left" },
  { id: "createdAt", header: "가입일시", width: 160, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `member-row-skeleton-${index}`).map((key) => (
