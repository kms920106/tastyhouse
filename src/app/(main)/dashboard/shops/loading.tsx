...
const SKELETON_COLUMNS = [
  ...
  { id: "name", header: "가게명", width: 200, align: "left" },
  { id: "stationName", header: "지하철역", width: 120, align: "left" },
  { id: "roadAddress", header: "주소", width: 240, align: "left" },
  { id: "rating", header: "평점", width: 80, align: "left" },
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div>
            <Table className="table-fixed **:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
              ...
              <TableBody>
                {Array.from({ length: SKELETON_ROW_COUNT }, (_, index) => `shop-row-skeleton-${index}`).map((key) => (
