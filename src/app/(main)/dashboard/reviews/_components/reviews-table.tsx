...
import type { ReviewsTableMeta } from "./reviews-columns";
...
export function ReviewsTable({ table, isPending }: { table: TableType<ReviewListItem>; isPending: boolean }) {
  ...
  const totalElements = (table.options.meta as ReviewsTableMeta).totalElements;
    ...
    <div className="flex flex-1 flex-col gap-4">
      <div>
        ...
        >
          ...
          <TableBody>
            {isPending ? (
              Array.from({ length: pageSize }, (_, index) => `review-row-skeleton-${index}`).map((key) => (
        ...
        <div className="flex items-center gap-4 text-muted-foreground text-sm">
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              disabled={isPending}
            >
              <SelectTrigger size="sm" className="w-20" id="reviews-rows-per-page">
